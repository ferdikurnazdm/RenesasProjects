...
#include "task.h"
#include "semphr.h"
extern void REDLED_thread_create(void);
extern TaskHandle_t REDLED_thread;
extern void BLUERED_thread_create(void);
extern TaskHandle_t BLUERED_thread;
...
int main(void)
{
    ...
    /* Init RTOS tasks. */
    REDLED_thread_create ();
    BLUERED_thread_create ();
